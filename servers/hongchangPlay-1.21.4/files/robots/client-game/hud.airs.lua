...
local displayName = aris.client.create_default_text_renderer("§l깃터", 0X000000)
displayName:set_scale(6)
local a = center_x1("깃터", 6)
displayName:set_x(a)
displayName:set_y(60)
hud:add_child(displayName)

local money = aris.client.create_default_text_renderer("1234타코", 0X000000)
money:set_scale(4)
money:set_x(center_x1("1234타코", 4))
money:set_y(165)
hud:add_child(money)
